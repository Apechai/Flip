...
- (void) touchesEnded: (NSSet *) touches withEvent: (UIEvent *) event {
	...
	*/
    ...
    // curl page up if it's switching from LittieView0 to Littleview1 otherwise curldown
    if (index == 0) {switchpage = UIViewAnimationOptionTransitionCurlUp;}
    else
    {switchpage = UIViewAnimationOptionTransitionCurlDown;}
